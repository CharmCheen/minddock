...
_FUTURE_SOURCE_SKILLS: tuple[SkillInfo, ...] = (
    ...
    SkillInfo(
        ...
        version="0.1.0",
        status="future",
        description="Transcribe audio files into searchable text.",
        ...
        limitations=("not_implemented", "requires_asr_provider"),
        enabled=False,
        origin="builtin",
    ),
    SkillInfo(
        ...
        version="0.1.0",
        status="future",
        description="Extract speech text from video files.",
        input_kinds=(".mp4", ".mov", ".mkv"),
        output_type="SourceLoadResult",
        source_media="video",
        source_kind="video_file",
        loader_name="video.transcribe",
        capabilities=("video_audio_transcription",),
        limitations=("not_implemented", "no_scene_understanding"),
        enabled=False,
        origin="builtin",
    ),
    SkillInfo(
